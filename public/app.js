...
const questionOneCult1 = '<p>PREGUNTAS SOBRE CULTURA</p><p>1.-¿Cuál país es conocido por bailar tango?</p><div class ="radio"><input type= "radio" id="baile" name="baile" value="v1" > <label >Chile</label></div><div class ="radio"><input type= "radio" id="baile" name="baile" value="v2"> <label>Argentina</label></div> <div class ="radio"><input type= "radio" id="baile" name="baile" value="v3"> <label >Paraguay</label></div><input type="hidden" id="question" value="q1"><p class="Error" id = "Error">Debe Seleccionar una de las opciones</p><button onclick="nextQuestion()">Siguiente</button><div class = "buttonOptions"><button onclick="home()">Salir</button> <button onclick="capture()">Volver</button> </div>';  
